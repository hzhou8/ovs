...
main(int argc, char *argv[])
{
    ...
    ovsdb_idl_omit_alert(ovninb_idl_loop.idl, &inbrec_inb_global_col_isb_cfg);
    ovsdb_idl_omit_alert(ovninb_idl_loop.idl, &inbrec_inb_global_col_az_cfg);
