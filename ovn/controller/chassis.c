...
find_chassis_nb_cfg(const struct sbrec_chassis_nb_cfg_table *nbcfg_table,
                    const char *chassis_id)
{
    const struct sbrec_chassis_nb_cfg *chassis_nb_cfg_rec;

    SBREC_CHASSIS_NB_CFG_TABLE_FOR_EACH (chassis_nb_cfg_rec, nbcfg_table) {
...
chassis_run(struct ovsdb_idl_txn *ovnsb_idl_txn,
            ...
            const struct sbrec_chassis_nb_cfg_table *chassis_nb_cfg_table,
            ...
            const struct sbrec_chassis_nb_cfg **nb_cfg)
{
    *nb_cfg = NULL;
    ...
    const struct sbrec_chassis_nb_cfg *chassis_nb_cfg_rec
        = find_chassis_nb_cfg(chassis_nb_cfg_table, chassis_id);
    if (!chassis_nb_cfg_rec) {
        chassis_nb_cfg_rec = sbrec_chassis_nb_cfg_insert(ovnsb_idl_txn);
                ...
                const struct sbrec_chassis_nb_cfg_table *chassis_nb_cfg_table)
{
    ...
    if (ovnsb_idl_txn) {
        ...
        const struct sbrec_chassis_nb_cfg *chassis_nb_cfg_rec
            = find_chassis_nb_cfg(chassis_nb_cfg_table, chassis_rec->name);
        if (chassis_nb_cfg_rec) {
